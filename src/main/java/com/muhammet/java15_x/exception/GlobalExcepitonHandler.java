...
public class GlobalExcepitonHandler {
    ...
    @ExceptionHandler(Java15XException.class)// istisnayı yakalayan kısım
    @ResponseBody
    public ResponseEntity<ErrorMessage> java15XExceptionHandler(Java15XException exception){
